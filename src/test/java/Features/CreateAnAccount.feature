...
Feature: Registro de usuarios
  ...
  Scenario Outline: Registrarse en la pagina ingresando todos los datos
    ...
    Examples: 
      ...
      | Mr.    | Daniel | Farias   | registro17@gmail.com | pass1  |     21 |      7 |    2000 | yes        | no     | NA       | direccion11 | direccion12 | United States | Arizona | ciudad1 |     11111 | infoAdicional1 | 4444455214 | 301211111 | alias1 |
  ...
  Scenario Outline: Registrarse en la pagina ingresando solo datos obligatorios
    ...
    Examples: 
      ...
      | Daniel | Farias   | registro18@gmail.com | pass1  | direccion11 | United States | Arizona | ciudad1 |     11111 | 301211111 | alias1 |
